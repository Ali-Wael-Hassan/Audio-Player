...
private:
    ...
    std::vector<juce::TextButton*> buttons = { &loadButton, &restartButton, &stopButton, &playButton, &muteButton, &go_to_startButton, &go_to_endButton, &speedButton, &repeatButton, &markerButton, &playlistButton};
    ...
    std::map<std::string, juce::TextButton*> mp = { {"load", &loadButton},
                                                    ...
                                                    {"speed", &speedButton},
                                                    {"repeat", &repeatButton},
                                                    {"Flag Marker A/B:Not Set", &repeatButton},
